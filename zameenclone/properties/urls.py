...
urlpatterns = [
    ...
    # api views
    # path("marketplace/", PropertyMarketplaceListAPIView.as_view(), name="marketplace_api"),
    # path("", PropertyListAPIView.as_view(), name="properties_api"),
    # path("offers/<int:id>/", PropertyOfferCreateAPIView.as_view(), name="create_offer_api"),
    # path("offers/", PropertyOfferListAPIView.as_view(), name="get_offers_api"),
    # path("<int:id>/offers/", PropertyOfferFromPropertyListAPIView.as_view(), name="get_property_offers_api"),
    # path("update-offers/<int:id>/", PropertyOfferUpdateStateAPIView.as_view(), name="update_state"),
    # path("offers/withdraw/<int:id>/", PropertyOfferWithdrawAPIView.as_view(), name="withdraw_offer_api"),
    # path("<int:id>/", PropertyRetrieveAPIView.as_view(), name="property"),
    # path("<int:id>/update/", PropertyUpdateAPIView.as_view(), name="update_property"),
    # path("add/", PropertyCreateAPIView.as_view(), name="add_property_api"),
