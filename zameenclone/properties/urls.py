...
urlpatterns = [
    ...
    path("view_property_offers", views.view_property_offers, name="view_property_offers"),
    ...
    path("offer/<int:offer_id>/withdraw_offer", views.withdraw_offer, name="withdraw_offer")
]
